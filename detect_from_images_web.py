...
if __name__ == '__main__':
    ...
    # Store the initial number of files in the folder
    input_initial_count = len(input_files)
    ...
    while True:
        ...
        if len(input_files) > 0:
            ...
            while True:
                ...
                # it was if(len(output_files) > output_initial_count):
                if(len(output_files) == output_initial_count+len(input_files)):
